...
import classes from "./BigCoursePage.module.css";
...
export default function BigCoursePage() {
  const {id} = useParams()
  const [bigCourse, setBigCourse] = useState();

  useEffect(() => {
    fetch(`https://internships-api.onrender.com/bigCourses/${id}`)
      .then(res => res.json())
