...
import FromInCourse from './component/FromInCourse/FromInCourse'
import CarosleComment from './component/CaroselComment/CaroselComment'
import classes from "./CoursePage.module.css";
import image from "./component/signup_page.png";
...
export default function CoursePage() {
  ...
  useEffect(() => {
    fetch(`https://internships-api.onrender.com/courses/${id}`)
      .then((res) => res.json())
